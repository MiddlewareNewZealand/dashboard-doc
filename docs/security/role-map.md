...
| ---------------- | --------------------------------------------- |
| profile          | ALL (r\*) [^1]                                |
| ALL utilisation  | SMT, FINANCE, ADMIN, JOB MANAGER (r\*)[^2]    |
| ALL forecast     | SMT, FINANCE, ADMIN, JOB MANAGER (r*/w*) [^3] |
| hiring           | SMT (r/w)                                     |
| leads            | ADMIN, SMT (r)                                |
| ALL times        | ??? (r)[^4]                                   |
| leave            | ALL (r)                                       |
...
[^5]: Non-admins should only be able to access their own jobs.
