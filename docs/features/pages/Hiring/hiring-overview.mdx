...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
  <div>
    #### Pages:
    - [index](./hiring-index.md)
    - [detail](./hiring-detail.md)
  ...
  <div>
    #### Client Dataflow:
    - [Api](../../../client-datflow/Hiring/hiring-api.md)
    - Redux
    - HiringContainer
    - ApplicantProfileContainer

    #### Cloud:
    - [Firestore/hiring](../../../cloud/Firestore/Collections/hiring.md)
    - Firebase/applications

    #### Util:
    - [hiringController](../../../utils/hiring-controller.md)
  </div>
</div>
